...
export default {
  ...
  methods: {
    async onSubmit() {
      ...
      this.dupe = await items.updateItem(this.id, this.itemQuantity);
      ...
      if (!this.dupe) {
        ...
        this.message = "PLU Does Not Exist";
        this.popUpStyle = false;
        this.displayPopUp();
        this.clearFields();
        return;
        ...
        this.message = "Item Updated Sucessfully";
        this.popUpStyle = true;
        this.displayPopUp();
      }
    },
    isEmpty() {
      if (this.id == null || this.itemQuantity == null) {
        this.displayPopUp();
